...
@section('title')
    <title>Manage Delivery | bdCalling IT Ltd</title>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Manage Delivery</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="frm" action="{{route('owner.delivery.report')}}" method="post">
                                    @csrf
                                    <div class="row mb-5">
                                        <div class="col col-md-4">
                                            <label for=""> Date</label>
                                            <input type="date" class="form-control" id="datavalue" name="dates">
                                            <button type="submit" class="btn btn-primary btn-sm mt-1" id="formsubmit">Report</button>
                                        </div>
                                    </div>
