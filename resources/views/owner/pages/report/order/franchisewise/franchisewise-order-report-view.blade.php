                ...
                <div class="card-body">
                  ...
                  <table class="table table-hover table-stripped table-sm table-bordered table-responsive">
                    ...
                    <tbody id="table">
                      ...
                      <?php 
                      $getFranchise = App\Models\OrderDeliver::select('franchise_id')->whereYear('created_at', $year)->whereMonth('created_at', $month)->groupBy('franchise_id')->with('franchise')->get();
                      ?>
                      ...
                      <tr class="tablerow">
                        ...
                        @foreach($getReport as $key=>$value)
                          <td class="orderAmount">
                            ...
                            $getFranchiseAmount = App\Models\OrderDeliver::select(DB::raw('sum(deli_amount) as deli_amount'), 'inc_date')->whereYear('created_at', $year)->whereMonth('created_at', $month)->where('franchise_id', $franchise_id)->where('inc_date', $fix_day)->groupBy('inc_date')->count();
                            if($getFranchiseAmount == '0'){
                              echo "0";
                            }else{
                              $getFranchiseAmount_with_this_date = App\Models\OrderDeliver::select(DB::raw('sum(deli_amount) as deli_amount'), 'inc_date')->whereYear('created_at', $year)->whereMonth('created_at', $month)->where('franchise_id', $franchise_id)->where('inc_date', $fix_day)->groupBy('inc_date')->get();
                  ...
                  <table class="table table-hover table-stripped table-sm table-bordered table-responsive">
                    ...
                    <tbody id="table">
                      ...
                      <?php 
                      $getFranchise = App\Models\OrderDeliver::select('franchise_id')->where('franchise_id', $franchise_id)->whereYear('created_at', $year)->whereMonth('created_at', $month)->groupBy('franchise_id')->with('franchise')->get();
                      ?>
