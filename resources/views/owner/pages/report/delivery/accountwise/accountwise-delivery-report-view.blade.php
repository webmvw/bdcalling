          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card">
              <div class="card-body">
                 ...
                 <form id="quickForm" action="{{ route('owner.accountwiseDeliveryReportRequest') }}" method="post">
                  @csrf
                  <div class="row">
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title">Account Wise Delivery Report</mark></h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                  @if($franchise_id == 'all')
                   <table class="table table-hover table-stripped table-sm table-bordered table-responsive">
                    ...
                    <tbody id="table">
                      ...
                      <?php 
                      $getAccount = App\Models\OrderDeliver::select('franchise_id', 'account_id')->whereYear('deli_date', $year)->whereMonth('deli_date', $month)->groupBy('franchise_id')->groupBy('account_id')->with('franchise', 'account')->get();
                      ?>
                      ...
                      <tr class="tablerow">
                        ...
                        @foreach($getReport as $key=>$value)
                          <td class="deliveryAmount">
                            ...
                            $getAccountAmount = App\Models\OrderDeliver::select(DB::raw('sum(deli_amount) as deli_amount'), 'deli_date')->whereYear('deli_date', $year)->whereMonth('deli_date', $month)->where('franchise_id', $franchise_id)->where('account_id', $account_id)->where('deli_date', $fix_day)->groupBy('deli_date')->count();
                            if($getAccountAmount == '0'){
                              echo "0";
                            }else{
                              $getAccountAmount_with_this_date = App\Models\OrderDeliver::select(DB::raw('sum(deli_amount) as deli_amount'), 'deli_date')->whereYear('deli_date', $year)->whereMonth('deli_date', $month)->where('franchise_id', $franchise_id)->where('account_id', $account_id)->where('deli_date', $fix_day)->groupBy('deli_date')->get();
                  ...
                  <table class="table table-hover table-stripped table-sm table-bordered table-responsive">
                    ...
                    <tbody id="table">
                      ...
                      <?php 
                      $getAccount = App\Models\OrderDeliver::select('franchise_id', 'account_id')->whereYear('deli_date', $year)->whereMonth('deli_date', $month)->where('franchise_id', $franchise_id)->groupBy('franchise_id')->groupBy('account_id')->with('franchise', 'account')->get();
                      ?>
