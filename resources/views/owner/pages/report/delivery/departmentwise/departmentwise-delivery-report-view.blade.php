          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title">Department Wise Delivery Report</mark></h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                 @if($franchise_id == 'all')
                  ...
                  <table class="table table-hover table-stripped table-sm table-bordered table-responsive">
                    ...
                    <tbody id="table">
                      ...
                      <?php 
                      $getDepartment = App\Models\OrderDeliver::select('franchise_id', 'department_id')->whereYear('deli_date', $year)->whereMonth('deli_date', $month)->where('franchise_id', $franchise_id)->groupBy('franchise_id')->groupBy('department_id')->with('franchise', 'department')->get();
                      ?>
