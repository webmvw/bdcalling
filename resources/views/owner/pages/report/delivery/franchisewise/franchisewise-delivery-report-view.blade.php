                ...
                <div class="card-body">
                  ...
                  <table class="table table-hover table-stripped table-sm table-bordered table-responsive">
                    ...
                    <tbody id="table">
                      ...
                      <?php 
                      $getFranchise = App\Models\OrderDeliver::select('franchise_id')->whereYear('deli_date', $year)->whereMonth('deli_date', $month)->where('franchise_id', $franchise_id)->groupBy('franchise_id')->with('franchise')->get();
                      ?>
