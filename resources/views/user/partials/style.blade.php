<!-- Font Awesome -->
  ...
  <!-- toastr css -->
  <link rel="stylesheet" type="text/css" href="{{ asset('public/admin/plugins/toastr/toastr.min.css') }}">

   <!-- sweetalert2 css -->
  <link rel="stylesheet" type="text/css" href="{{ asset('public/admin/plugins/sweetalert2/sweetalert2.min.css') }}">
