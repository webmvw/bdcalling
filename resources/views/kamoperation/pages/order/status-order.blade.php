...
@section('title')
  <title>Order Status | bdCalling IT Ltd</title>
@endsection
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              ...
              <!-- /.card-header -->
                 <form method="post" action="{{ route('kamoperation.order.status.update', $getOrder->id) }}" id="quickForm" novalidate="novalidate"> 
                  @csrf
                    <div class="card-body">
