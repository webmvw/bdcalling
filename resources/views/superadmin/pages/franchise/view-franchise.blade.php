          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('franchise.add') }}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Add Franchise</a>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      @foreach($allfranchises as $key=>$value)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('franchise.edit', $value->id) }}" title="Edit" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('franchise.delete', $value->id) }}" onclick="return confirm('Are you sure to delete!');" title="Delete" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                          </td>
                        </tr>
                    @endforeach
