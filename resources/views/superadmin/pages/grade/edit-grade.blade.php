                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" value="{{ $getGrade->grade_name }}" name="grade_name" class="form-control" id="grade_name" placeholder="Enter Grade Name">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="amount">Amount</label>
                            <input type="number" value="{{ $getGrade->amount }}" name="amount" id="amount" placeholder="Grade Amount" class="form-control">
                          </div>
                        </div>
                      </div>
                    </div>
