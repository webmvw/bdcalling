...
@section('title')
  <title>Add Kam | BdCalling it ltd</title>
@endsection
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Kam</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title">Add Kam</h3>
                <a href="{{ route('kam.view') }}" class="btn btn-success btn-sm"><i class="fa fa-list"></i> Kam List</a>
              </div>

              <!-- /.card-header -->
                 <form method="post" action="{{ route('kam.store') }}" id="quickForm" novalidate="novalidate" enctype="multipart/form-data"> 
                  @csrf
                    <div class="card-body">
