          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('franchiseowner.employee.add') }}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Add Employee</a>
              </div>
                    ...
                    <tbody>
                      @foreach($allData as $key=>$value)
                        <tr>
                          ...
                          @endif
                          <td>
                            <a href="{{ route('franchiseowner.employee.show', $value->id) }}" title="View" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                            @php
                            ...
                            @endphp
                            @if($incrementValue == 0)
                            <a href="{{ route('franchiseowner.employee.edit', $value->id) }}" title="Edit" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                            @endif
                          </td>
                        </tr>
                    @endforeach
