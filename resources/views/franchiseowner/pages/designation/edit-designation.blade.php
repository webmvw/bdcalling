        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('franchiseowner.designation.view') }}">Designation</a></li>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('franchiseowner.designation.view') }}" class="btn btn-success btn-sm"><i class="fa fa-list"></i> Designation List</a>
              </div>

              <!-- /.card-header -->
                 <form method="post" action="{{ route('franchiseowner.designation.update', $designation->id) }}" id="quickForm" novalidate="novalidate"> 
                  @csrf
                    <div class="card-body">
