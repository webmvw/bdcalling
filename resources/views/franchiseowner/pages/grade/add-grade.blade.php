          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('franchiseowner.grade.view') }}" class="btn btn-success btn-sm"><i class="fa fa-list"></i> Grade List</a>
              </div>

              <!-- /.card-header -->
                 <form method="post" action="{{ route('franchiseowner.grade.store') }}" id="quickForm" novalidate="novalidate"> 
                  @csrf
                    <div class="card-body">
