...
class AccountController extends Controller
{
    ...
    public function store(Request $request){
    	...
    	$account->save();
    	return redirect()->route('admin.account.view')->with("success", "Account Added Successfully!!");
    }
    ...
    public function delete($id){
    	$account = Account::find($id);
    	$account->delete();
    	return redirect()->route('admin.account.view')->with("success", "Account deleted Successfully!!");
    }
