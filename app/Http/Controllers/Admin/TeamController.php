...
class TeamController extends Controller
{
    public function view(){
    	...
    	return view('admin.pages.team.view-team', $data);
    }
    ...
    public function add(){
    	...
    	return view('admin.pages.team.add-team', $data);
    }
    ...
    public function store(Request $request){
    	...
    	$team->save();
    	return redirect()->route('admin.team.view')->with("success", "Team Added Successfully!!");
    }
    ...
    public function edit($id){
    	...
    	return view('admin.pages.team.edit-team', $data);
    }
    ...
    public function update(Request $request, $id){
        ...
        $team->department_id = strip_tags($request->department_id);
    	$team->save();
    	return redirect()->route('admin.team.view')->with("success", "Team updated Successfully!!");
    }

    public function delete($id){
    	$getteam = Team::find($id);
    	$getteam->delete();
    	return redirect()->route('admin.team.view')->with("success", "Team deleted Successfully!!");
    }
}
