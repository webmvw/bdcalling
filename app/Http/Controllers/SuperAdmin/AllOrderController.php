...
class AllOrderController extends Controller
{
    public function allOrderView()
    {
        ...
        return view('superadmin.pages.all-order-list.all-order-list', compact('allData'));
    ...
    public function view(Request $req)
    {
        ...
        if (!empty($day)) {
            ...
            return view('superadmin.pages.all-order-list.report-view', compact('result', 'Total_amount', 'Total_Platform_charge', 'deli_amount', 'Convert'));
    ...
    public function DeliveryView()
    {
        ...
        return view('superadmin.pages.all-order-list.all-delivery-list', compact('allData'));
    }
    ...
    public function deliveryReport(Request $req)
    {
        ...
        if (!empty($day)) {
            ...
            $Convert = date("d/m/Y", strtotime($day));
            return view('superadmin.pages.all-order-list.delivery-report-view', compact('result', 'Total_amount', 'Total_Platform_charge', 'deli_amount', 'Convert'));
